...
desc 'Generate documentation for the product_attachment extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductAttachmentExtension'
...
desc 'Test the product_attachment extension.'
...
namespace :test do
  desc 'Functional test the product_attachment extension.'
  ...
  desc 'Unit test the product_attachment extension.'
